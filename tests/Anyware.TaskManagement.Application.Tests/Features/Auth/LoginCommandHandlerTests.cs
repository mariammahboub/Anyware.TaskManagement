...
public sealed class LoginCommandHandlerTests
{
    ...
    public async Task Handle_InvalidCredentials_ErrorMessageDoesNotRevealWhichFieldIsWrong()
    {
        ...
        try { await CreateHandler().Handle(new LoginCommand("x@x.com", "password"), CancellationToken.None); }
        ...
        try { await CreateHandler().Handle(new LoginCommand("x@x.com", "wrong"), CancellationToken.None); }
